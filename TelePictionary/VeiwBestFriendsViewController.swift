//
//  VeiwBestFriendsViewController.swift
//  TelePictionary
//
...
class VeiwBestFriendsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, GroupGCViewControllerDelegate, UIPopoverPresentationControllerDelegate  {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if Reachability.isConnectedToNetwork() {
            ...
            let URLData = GetMyFriends(userID, Type: "bestfriends")
            //println(test)
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == UITableViewCell.EditingStyle.delete {
          ...
          //  self.NumbersInfo.removeLast()
            ...
            DeleteMyFriend(self.userID, FriendType: "bestfriends", NewID: RemoveID, NewName: RemoveName)
...
extension VeiwBestFriendsViewController {
    func GroupGCViewControllerFinished(_ groupgcviewController: GroupGCViewController) {
        ...
        AddMyFriend(self.userID, FriendType: "bestfriends", NewID: GCFriendID, NewName: self.GCFriendName)
        ...
        if Reachability.isConnectedToNetwork() {
           ...
           let URLData = GetMyFriends(self.userID, Type: "bestfriends")
            //println(test)
